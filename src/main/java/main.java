...
public class main {
    public static void main(String[] args) {
        ...
        Viajero v5 = new Viajero("48934879", "Rondro", "tumbadeestrella@gmail.com", 31, Categoria.PLATINO);
        Viajero v6 = new Viajero("90423849", "Carrusel", "gyfin@gmail.com", 31, Categoria.PLATINO);
        Viajero v7 = new Viajero("99594873", "madozito", "asdsd@gmail.com", 31, Categoria.ESTANDAR);
